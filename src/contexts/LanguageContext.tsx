...
const zh: Record<string, string> = {
  ...
  "todo.matrix.do_now": "立即做",
  "todo.matrix.plan": "计划做",
  "todo.matrix.delegate": "委托做",
  "todo.matrix.drop": "考虑删",
  "todo.pomodoro": "🍅 番茄钟",
  ...
  "wealth.passive_low": "被动收入还在起步，继续建设你的收入管道",
  "wealth.passive_mid": "不错的被动收入占比，继续优化",
  "wealth.passive_high": "优秀！被动收入已占大头",
  "wealth.expense_category": "支出分类",
  "wealth.income_source": "收入来源",
  "wealth.energy_income": "精力 × 收入关联",
  "wealth.energy_days": "基于{days}天数据 · 高精力日通常产出更高价值",
  "wealth.wisdom_title": "财商升维",
  "wealth.wisdom_checklist": "财商认知清单",
  "wealth.asset_vs_liability": "资产 vs 负债",
  "wealth.asset_vs_liability_desc": "让你口袋里的钱增加的是资产，减少的是负债",
  "wealth.active_vs_passive": "主动 vs 被动",
  "wealth.active_vs_passive_desc": "你停止工作后收入是否还在？",
  "wealth.time_vs_system": "时间出租 vs 系统产出",
  "wealth.time_vs_system_desc": "按小时计费=出租，产品/内容复利=系统",
  "wealth.consume_vs_invest": "消费 vs 投资",
  "wealth.consume_vs_invest_desc": "花钱前问自己——这笔钱3年后还在为我创造价值吗？",

  // HomePage starter prompts
  "home.starter.record": "记录今天发生了什么",
  "home.starter.record_msg": "帮我回顾一下今天，我来说说发生了什么",
  "home.starter.plan": "规划我的一天",
  "home.starter.plan_msg": "帮我规划一下今天要做的事情",
  "home.starter.thoughts": "聊聊最近的想法",
  "home.starter.thoughts_msg": "我最近有些想法想整理一下",
  "home.starter.review": "复盘这周表现",
  "home.starter.review_msg": "帮我复盘一下这周的表现",
...
const en: Record<string, string> = {
  ...
  "todo.matrix.do_now": "Do Now",
  "todo.matrix.plan": "Plan",
  "todo.matrix.delegate": "Delegate",
  "todo.matrix.drop": "Consider Drop",
